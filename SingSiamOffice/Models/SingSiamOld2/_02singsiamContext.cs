...
public partial class _02singsiamContext : DbContext
{
    ...
    public virtual DbSet<Getpromise> Getpromises { get; set; }
    ...
    public virtual DbSet<Logfile202504> Logfile202504s { get; set; }

    public virtual DbSet<Logfile202505> Logfile202505s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Getpromise>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("getpromise");
        ...
        modelBuilder.Entity<Logfile202504>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity
                .ToTable("logfile_202504")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<Logfile202505>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity
                .ToTable("logfile_202505")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
